...
* 크레인 인형뽑기
* 문제 분석:
* 1. 총 4개의 파라미터가 들어오는데 가장 핵심이 2차원 배열이다.
* 2. 2차원 배열의 숫자가 의미하는 것은 인형의 타입이라고 생각하면 될 것 같다.
* 3. 크레인의 움직임을 의미하는 파라미터가 크레인의 움직임을 의미하며 그 값을 순서로 2차원 배열의 인형을 뽑는다.
* 4. 뽑은 인형을 바구니에 담는 문제인데, 같은 타입의 인형을 담았다면 들어있는 인형과 크레인이 뽑은 인형 둘 다 사라진다.
* 5. 최종 사라진 인형의 갯수를 리턴하면 된다.
*
* */
